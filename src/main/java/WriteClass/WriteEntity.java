...
public class WriteEntity {
    ...
    public void Write(String table) {
        ...
        locahost = address + "src\\main\\java\\WriteClass\\"; // newEntity 类 路径
    ...
    private void entity(String path, String pak) {
        ...
        entity_txt.append("import com.hb.common.entity.BaseEntity; ").append("\r\n"); // 包名
        entity_txt.append("\r\n");
        ...
        entity_txt.append("@Table(name = \"").append(table_name).append("\")\r\n");
